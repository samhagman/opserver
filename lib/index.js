...
function buildOpserver() {
    ...
    var mongoAdminUser = _ref.mongoAdminUser;
    var mongoAdminPass = _ref.mongoAdminPass;
    var mongoReadOnlyUser = _ref.mongoReadOnlyUser;
    var mongoReadOnlyPass = _ref.mongoReadOnlyPass;
    var _ref$mongoAdminConnec = _ref.mongoAdminConnectionOptions;
    var mongoAdminConnectionOptions = _ref$mongoAdminConnec === undefined ? {} : _ref$mongoAdminConnec;
    var _ref$mongoReadOnlyCon = _ref.mongoReadOnlyConnectionOptions;
    var mongoReadOnlyConnectionOptions = _ref$mongoReadOnlyCon === undefined ? {} : _ref$mongoReadOnlyCon;
    ...
    return new Promise(function (resolve, reject) {
         ...
         * @type {object}
         */
        var mongoDbAdminOptions = Object.assign({}, mongoAdminConnectionOptions);
        ...
        return mClient.connect(mongoURI, mongoDbAdminOptions).then(function (db) {
            ...
            adminDb.authenticate(mongoAdminUser, mongoAdminPass).then(function (result) {
                ...
                return adminDb.listDatabases().tap(function (dbs) {
                    ...
                    var dbConnectPromises = databases.map(function (database) {
                        ...
                        var connectionPromise = new Promise(function (resolve, reject) {
                            mClient.connect(uri, mongoReadOnlyConnectionOptions).then(function (db) {
                                dbConn = db;
